...
class DiseasePredictorApp:
    ...
    def create_widgets(self):
        ...
        ttk.Button(button_frame, text="Predict Disease", command=self.predict, style='Accent.TButton').pack(side=tk.LEFT, padx=10)
        ...
        results_frame = ttk.LabelFrame(
            ...
            style='TLabelframe'  # Corrected style name
        )
